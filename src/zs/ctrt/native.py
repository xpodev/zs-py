...
#             return target.is_subclass_of(self)
#         return super().assignable_to(target)
#
#     def is_subclass_of(self, base: TypeProtocol) -> bool:
#         if base is self:
#             return True
...
#                 return True
#         for base_ in self.__bases__:
#             if isinstance(base_, _TypeMeta) and base_.is_subclass_of(base):
#                 return True
#         return False
#
#
...
#
#
# class _NativeClassMeta(_NativeTypeMeta):
#     def __init__(cls, name: str, bases: tuple, namespace: dict):
#         super().__init__(name, bases, namespace)
#         self.runtime_type = cls
#
#         for name, item in namespace.items():
...
#
#
# # class NativeObject(, metaclass=_NativeClassMeta):
# #     def __init__(self):
# #         super().__init__(type(self))
# #
...
#
#
class NativeFunction(CallableProtocol, BindProtocol):
    name: str
    _native: Callable[..., typing.Any]

    def __init__(self, native: Callable[..., typing.Any], type: CallableTypeProtocol, name: str = None):
        self._native = native
        try:
